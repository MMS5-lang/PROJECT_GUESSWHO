 ...
 */
 ...
 module render_modules_tb;
    ...
    begin
        ...
        ui_in.hcount = '0; ui_in.vcount = '0; ui_in.hsync = 1'b0; ui_in.vsync = 1'b0; ui_in.hblnk = 1'b0; ui_in.vblnk = 1'b0; ui_in.rgb = '0;
        board_in.hcount = '0; board_in.vcount = '0; board_in.hsync = 1'b0; board_in.vsync = 1'b0; board_in.hblnk = 1'b0; board_in.vblnk = 1'b0; board_in.rgb = '0;
        text_in.hcount = '0; text_in.vcount = '0; text_in.hsync = 1'b0; text_in.vsync = 1'b0; text_in.hblnk = 1'b0; text_in.vblnk = 1'b0; text_in.rgb = '0;
        face_in.hcount = '0; face_in.vcount = '0; face_in.hsync = 1'b0; face_in.vsync = 1'b0; face_in.hblnk = 1'b0; face_in.vblnk = 1'b0; face_in.rgb = '0;
